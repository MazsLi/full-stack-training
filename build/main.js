...
const { app, BrowserWindow, protocol } = __webpack_require__(16);
...
registerProtocol = (name, refDir) => {
    ...
    protocol.registerFileProtocol(name, (request, callback) => {
        ...
        if (error) console.error('Failed to register protocol: ' + name);else debug('core:protocol')('Success to register protocol: ' + name);
    });
};
